...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--test_bsz", type=int, default=25, help="mini-batch size for testing")
        ...
        self.parser.add_argument("--vid_feat_path", type=str, default="./data/tvqa_imagenet_pool5_hq.h5",
